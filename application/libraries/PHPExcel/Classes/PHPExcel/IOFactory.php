...
class PHPExcel_IOFactory
{
     ...
     */
    public function __construct() { } //era private 001
	...
	public static function createWriter(PHPExcel $phpExcel, $writerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				...
				$classFile = str_replace('{0}', $writerType, $searchLocation['path']); //NO TENIA 001

				$instance = new $className($phpExcel);
				if (!is_null($instance)) { //($instance !== NULL) 001
					return $instance;
				}
			}
		}
	...
	public static function createReader($readerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				...
				$classFile = str_replace('{0}', $readerType, $searchLocation['path']); //NO TENIA 001
