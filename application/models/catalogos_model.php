...
class Catalogos_model extends CI_Model
{
	...
	function Tipo_NotaCredito()
	{
		...
		//$lista=array()
		$lista=array (
			"0"  => array ( "codigo"=> "01","nombre"=> "Anulaci�n de la operaci�n"),
			"1"  => array ( "codigo"=>  "02","nombre" => "Anulaci�n por error en el RUC"),
			"2"  => array ( "codigo"=>  "03","nombre" => "Correcci�n por error en la descripci�n"),
			"3"  => array ( "codigo"=>  "04","nombre" => "Descuento global"),
			"4"  => array ( "codigo"=>  "05","nombre" => "Descuento por �tem"),
			"5"  => array ( "codigo"=>  "06","nombre" => "Devoluci�n total"),
			"6"  => array ( "codigo"=>  "07","nombre" => "Devoluci�n por �tem"),
			"7"  => array ( "codigo"=>  "08","nombre" => "Bonificaci�n"),
			"8"  => array ( "codigo"=>  "09","nombre" => "Disminuci�n en el valor"),
