...
<head>
		...
		<script type="text/javascript">
			...
			ncsistema=
			{
				...
				Listar_ProductosDocumentoTabla:function(data,variable)
				{
					...
					$.each(data,function(key,rs)
					{
						...
						newHtml+='<tr>';
							...
							newHtml+='<td style="text-align:right">'+rs.val_unitario+'</td>';
				...
				Filtro_producto_tabla:function(data)
				{
					...
					newHtml+='<tr>';
						...
						newHtml+='<th style="width:10%">C�digo</td>';
						newHtml+='<th style="width:35%">Descripci�n</td>';
					...
					if (txt_config_valorprecio==0)
					{
						$.each(data,function(key,rs)
						{
							...
							newHtml+='<tr>';
								...
								newHtml+='<td style="text-align:center"><a href="javascript:Seleccionar_Producto('+rs.id+',\''+rs.cod_producto+'\',\''+rs.nom_largo+'\',\''+rs.valor_venta+'\',\''+rs.cod_unidmedsunat+'\')" ><img align="center" src="<?php echo base_url();?>application/helpers/image/ico/add.png" title="Imprimir" width="15"  height="15" border="0" ></a></td>';
					...
					}else
					{
						$.each(data,function(key,rs)
						{
							...
							newHtml+='<tr>';
								newHtml+='<td style="text-align:center">'+rs.nro_secuencia+'</td>';	//id, cod_producto, nom_corto, precio, cod_unidmedsunat, idmed
								newHtml+='<td style="text-align:center"><a href="javascript:Seleccionar_Producto('+rs.id+',\''+rs.cod_producto+'\',\''+rs.nom_largo+'\',\''+rs.precio_venta+'\',\''+rs.cod_unidmedsunat+'\')" ><img align="center" src="<?php echo base_url();?>application/helpers/image/ico/add.png" title="Imprimir" width="15"  height="15" border="0" ></a></td>';
								newHtml+='<td style="text-align:left">'+rs.cod_producto+'</td>';
								newHtml+='<td style="text-align:left">'+rs.nom_corto+'</td>';
				...
				filtro_datosAdicionales_Tabla:function(data)
				{
					...
					$.each(data,function(key,rs)
					{
						...
						newHtml+='<tr>';
							...
							newHtml+='<td style="text-align:left"><input style="width:95%" type="text" id="txt_datoadicional_valor_'+key+'" name="txt_datoadicional_valor_'+key+'" value="" placeholder="M�ximo 40 caracteres" disabled="disabled" maxlength="40" /></td>';
						newHtml+='</tr>';
					});
				...
				Guardar_Einvoiceheader:function(tipo_registro)
				{
					...
					if (cmb_tipodocumentosunat=='07' || cmb_tipodocumentosunat=='08')
					{
						...
						if (cmb_tiponotadecredito=='0')
						{
							...
							{
								$('#div_MensajeValidacionEmpresa').fadeIn(0);
								$('#div_MensajeValidacionEmpresa').empty().append('<div style="width:4%;float:left;text-align:left"><img src="<?php echo base_url();?>application/helpers/image/ico/ncexclamacion.png"/></div><div style="margin-left:5px;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;padding-top:3px; width:80%;float:left;text-align:left">Seleccione el tipo de nota cr�dito</div>');
								setTimeout(function(){ $("#div_MensajeValidacionEmpresa").fadeOut(1500);},3000);
								return;
							}
							else
							{
								$('#div_MensajeValidacionEmpresa').fadeIn(0);
								$('#div_MensajeValidacionEmpresa').empty().append('<div style="width:4%;float:left;text-align:left"><img src="<?php echo base_url();?>application/helpers/image/ico/ncexclamacion.png"/></div><div style="margin-left:5px;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;padding-top:3px; width:80%;float:left;text-align:left">Seleccione el tipo de nota de d�bito</div>');
								setTimeout(function(){ $("#div_MensajeValidacionEmpresa").fadeOut(1500);},3000);
								return;
							}
						}
					...
					{
						$('#div_MensajeValidacionEmpresa').fadeIn(0);
						$('#div_MensajeValidacionEmpresa').empty().append('<div style="width:4%;float:left;text-align:left"><img src="<?php echo base_url();?>application/helpers/image/ico/ncexclamacion.png"/></div><div style="margin-left:5px;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;padding-top:3px; width:80%;float:left;text-align:left">Debe ingresar el n�mero para el documento</div>');
						setTimeout(function(){ $("#div_MensajeValidacionEmpresa").fadeOut(1500);},3000);
						return;
					}
					...
					{
						$('#div_MensajeValidacionEmpresa').fadeIn(0);
						$('#div_MensajeValidacionEmpresa').empty().append('<div style="width:4%;float:left;text-align:left"><img src="<?php echo base_url();?>application/helpers/image/ico/ncexclamacion.png"/></div><div style="margin-left:5px;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;padding-top:3px; width:80%;float:left;text-align:left">El cliente no existe, no tiene raz�n social</div>');
						setTimeout(function(){ $("#div_MensajeValidacionEmpresa").fadeOut(1500);},3000);
						return;
					}
					/*
					...
					*/
					...
					if (parseFloat(txt_importetotal)>700)
					{
						...
						var mensaje = confirm("Por Resoluci�n de Superintendencia N�183-2004/SUNAT indica que si el importe Total es mayor a \n 700.00 (setecientos y 00/100 Soles), el comprobante deber� estar afecto a Detracci�n. \n Desea continuar con la Emisi�n del Comprobante?");
					...
					{
						$('#div_MensajeValidacionEmpresa').fadeIn(0);
						$('#div_MensajeValidacionEmpresa').empty().append('<div style="width:4%;float:left;text-align:left"><img src="<?php echo base_url();?>application/helpers/image/ico/ncexclamacion.png"/></div><div style="margin-left:5px;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;padding-top:3px; width:80%;float:left;text-align:left">Ingresar todos los datos para la detracci�n</div>');
						setTimeout(function(){ $("#div_MensajeValidacionEmpresa").fadeOut(1500);},3000);
						return;
					}
					...
					{
						$('#div_MensajeValidacionEmpresa').fadeIn(0);
						$('#div_MensajeValidacionEmpresa').empty().append('<div style="width:4%;float:left;text-align:left"><img src="<?php echo base_url();?>application/helpers/image/ico/ncexclamacion.png"/></div><div style="margin-left:5px;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;padding-top:3px; width:80%;float:left;text-align:left">Ingresar todos los datos para la percepci�n</div>');
						setTimeout(function(){ $("#div_MensajeValidacionEmpresa").fadeOut(1500);},3000);
						return;
					}
			...
			function Registrar_DatosAdicionales()
			{
				...
				{
					alert("Solo est� permitido seleccionar 56 Campos Adicionales!");
					return;
				}
				...
				*/
				...
				else
				{
					...
					if (cod_tipodocumento=='01')
					{
						...
						Listar_SeriesDocumentos(cod_tipodocumento,cod_serie,tipodocreferencia,codserafectado);
						$('#div_catalogonombcliente').empty().append('Raz�n Social Cliente:');
					...
					else if (cod_tipodocumento=='03')
					{
						...
						newHtml+='<option value="4">Carnet de Extranjer�a</option>';
						newHtml+='<option value="6">RUC</option>';
						newHtml+='<option value="7">Pasaporte</option>';
						newHtml+='<option value="A">Ced. Diplom�tica de Identidad</option>';
			...
			function Listar_SeriesDocumentos(cod_tipodocumento,cod_serie,tipodocreferencia,codserafectado)
			{
				...
				if(cod_tipodocumento=='07' || cod_tipodocumento=='08')//ES NOTA DE CREDITO Y NOTA DE DEBITO
				{
					...
					if(cod_tipodocumento=='07')
					{
						...
						$('#div_etiquetetipodenota').empty().append('Tipo Nota de Cr�dito:');
						$url='<?php echo base_url()?>catalogos/Tipo_NotaCredito';
					}
					else
					{
						$('#div_etiquetetipodenota').empty().append('Tipo Nota de D�bito:');
			...
			function Tipo_Afectacion()
			{
				...
				if ($("#cbox_exportaciondocumento").is(":checked"))//EXPORTACION
				{
					...
					newHtml+='<option value="40">EXPORTACI�N</option>';
					newHtml+='</select>';
			...
			function Seleccionar_Check_opegravada()
			{
				...
				if ($("#chekbox_opegravada").is(":checked"))
				{
					if (txt_operaciongravadas>0)
					{
						...
						alert('Seleccionar otro cargo de operaci�n!.');
						}
				}else{
					txt_otroscargos=0;
				}
    ...
    <body>
				...
				<div id="div_datosempresa" style="width:100%; float:left; margin-top:10px; border: 1px solid #a6c9e2; border-radius:5px;">
					...
					<table border="0" width="80%" style="border-collapse:separate; border-spacing:1px 1px;" cellpadding="3" class="tablaFormulario">
						...
						<tr>
							...
							<td style="text-align:right;width:17%"><label class="columna">Raz�n Social Proveedor:</label></td>
							...
							<td style="text-align:left" colspan="3">
								<table width="100%" border="0">
									<tr>
										...
										<td style="text-align:right;width:7%"><label class="columna">N�mero:</label></td>
										<td style="width:14%">
											<input style="width:100%;text-align:center" type="text" id="txt_numerodocumentosunat" disabled="disabled" value="" >
										</td>
										<td style="text-align:right;width:20%"><label class="columna">Fec. Emisi�n:</label></td>
								...
								<table width="100%" border="0">
									<tr>
										...
										<td style="text-align:right;width:35%" >
											<label class="columna"><div id="div_etiquetetipodenota">Tipo Nota de Cr�dito:</div></label></td>
						...
						<tr>
							...
							<td style="text-align:right"><label class="columna"><div id="div_catalogonombcliente">Raz�n Social Cliente:</div></label></td>
							<td style="text-align:left" colspan="2">
								<table width="100%" border="0">
									<tr>
										<td style="width:40%">
						...
						<tr>
							...
							<td style="text-align:right"><label class="columna">Direcci�n Cliente:</label></td>
							<td style="text-align:left" colspan="2">
						...
						<tr>
							...
							<td style="text-align:right"></td><!--<label class="columna">Tipo de Operaci�n:</label>-->
							<td style="text-align:left" colspan="2">
								<table width="100%" border="0">
									<tr>
										<td style="text-align:right;width:40%;vertical-align:middle">
											<label class="columna"><div id="div_etiqueteexportacion">Exportaci�n:</div></label>
										</td>
										<td style="width:10%">
										...
										<tr id="row1">
											<td  style="text-align:left">
												<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left"
													...
													<span class="ui-button-icon-left ui-icon ui-icon-plusthick"></span>Ingresar Detracci�n</button>
											</td>
										</tr>
										<tr>
											<td style="text-align:left">
												<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left"
													...
													<span class="ui-button-icon-left ui-icon ui-icon-plusthick"></span>Ingresar Percepci�n</button>
											</td>
										</tr>
										<tr id="row_cargos">
											<td style="text-align:left">
		...
		<div id="dialog-form" title="Crear un Nuevo ITEM">
			...
			<table width="100%" border="0px">
								...
								<td width="100%">
									<select id="cmb_unidadmedida" style="width:97%;height:25px" >
										...
										<?php foreach ( $Listar_Unidades as $v):	?>
											<option value="<?php echo trim($v['codigo_unidad']); ?>"><?php echo trim(utf8_encode($v['nombre_unidad']));?> </option>
										<?php  endforeach; ?>
									</select>
								</td>
							</tr>
				...
				<tr>
					...
					<td colspan="4">
						<textarea id="txt_descripcion" style="width: 98%; height: 50px;text-transform:uppercase" placeholder="M�ximo 250 caracteres" maxlength="250" name="txt_ubicacion"></textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table width="100%" border="0" style="border-spacing:0px 0px;">
							<tr>
								<td width="40%">
									<input style="text-align:right" type="text" name="txt_cantidad" id="txt_cantidad" placeholder="0.0" onBlur="javascript:Calcular_Montos()">
								</td>
								<td >
								</td>
							</tr>
							...
							<tr>
								...
								<td  width="55%">
									<table width="100%" border="0" style="border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_valorunitario" id="txt_valorunitario" placeholder="0.0000000000" style="text-align:right" onBlur="javascript:Calcular_Montos()">
											</td>
											<td >
											</td>
										</tr>
							...
							<tr>
								...
								<td>
									<table width="100%" border="0" style="border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_descuento" id="txt_descuento" placeholder="0.0000000000" style="text-align:right" onBlur="javascript:Calcular_Montos()">
											</td>
											<td >
											</td>
										</tr>
							...
							<tr>
								...
								<td>
									<table width="100%" border="0" style=" border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_isc" id="txt_isc" placeholder="0.0000000000" disabled="disabled" style="text-align:right">
											</td>
											<td >
											</td>
										</tr>
							...
							<tr>
								...
								<td>
									<table width="100%" border="0" style=" border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_igv" id="txt_igv" placeholder="0.0000000000" disabled="disabled" class="" style="text-align:right">
											</td>
							...
							<tr>
								...
								<td>
									<table width="100%" border="0" style=" border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_valortotal" id="txt_valortotal" placeholder="0.0000000000" disabled="disabled" class="" style="text-align:right">
											</td>
											<td >
											</td>
										</tr>
							...
							<tr>
								...
								<td width="55%">
									<table width="100%" border="0" style="border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_precio" id="txt_precio" placeholder="0.0000000000"  disabled="disabled" style="text-align:right" onBlur="javascript:Calcular_Montos()">
											</td>
											<td >
											</td>
										</tr>
							...
							<tr>
								...
								<td>
									<table width="100%" border="0" style="border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_descuentoIGV" id="txt_descuentoIGV" placeholder="0.0000000000" disabled="disabled" style="text-align:right" onBlur="javascript:Calcular_Montos()">
											</td>
											<td >
											</td>
										</tr>
							...
							<tr>
								...
								<td>
									<table width="100%" border="0" style="border-spacing:0px 0px;">
										<tr>
											<td width="40%">
												<input type="text" name="txt_preciototal" id="txt_preciototal" placeholder="0.0000000000" disabled="disabled" style="text-align:right">
											</td>
											<td >
											</td>
										</tr>
		...
		<div id="dialog-form-detraccion" title="Detracci�n">
		 	<form>
			<table width="100%" border="0px">
				<tr>
					<td style="font-weight:bold;width:30%">% Detracci�n:</td>
					<td style="width:70%">
						<input type="text" id="txt_porcentajedetraccion" value="0.00" style="width:20%" onBlur="javascript:Calcular_Detraccion()">
					</td>
				</tr>
				<tr>
					<td style="font-weight:bold">Monto Detracci�n:</td>
					<td >
						<input type="text" id="txt_montodetraccion" disabled="disabled" value="0.00" style="width:40%" >
					</td>
				</tr>
				<tr>
					<td style="font-weight:bold">Monto Detracci�n referencial:</td>
					<td >
				...
				<tr>
					<td style="font-weight:bold">Cuenta del Banco de la Naci�n:</td>
					<td >
		...
		<div id="dialog-form-registrofactura" title="Respuesta de Registro">
		  <form>
			<table width="100%" border="0px">
				<tr>
					<td style="font-weight:bold;width:40%">N�mero de Factura:</td>
					<td style="width:60%">
		...
		<div id="dialog-form-registroboleta" title="Respuesta de Registro">
			...
			<table width="100%" border="0px">
				<tr>
					<td style="font-weight:bold;width:40%">N�mero de Boleta:</td>
					<td style="width:60%">
		...
		<div id="dialog-datosemisor" title="Datos del Proveedor">
			...
			<table width="100%" border="0px">
				...
				<tr>
					<td style="font-weight:bold">Pa�s:</td>
					<td >
				...
				<tr>
					<td style="font-weight:bold">Urbanizaci�n Emisor:</td>
					<td >
						<input type="text" id="txt_emisorrubanizacion" disabled="disabled" value="" style="width:90%" >
					</td>
				</tr>
				<tr>
					<td style="font-weight:bold">Direcci�n Emisor:</td>
					<td >
		...
		<div id="dialog-datoscliente" title="Datos del Cliente">
			...
			<table width="100%" border="0px">
				...
				<tr>
					<td style="font-weight:bold">Urbanizaci�n:</td>
					<td >
						<input type="text" id="txt_clienteubanizacion" disabled="disabled" value="" style="width:90%" >
					</td>
				</tr>
				<tr>
					<td style="font-weight:bold">Direcci�n Cliente:</td>
					<td >
		...
		<div id="dialog-datosbusquedaproducto" title="Filtro de Productos">
			...
			<table width="100%" border="0px">
				<tr>
					<td style="font-weight:bold; width:15%">C�digo:</td>
					<td style="width:20%">
					...
					<td style="font-weight:bold; width:15%">Descripci�n:</td>
					<td style="width:45%">
			...
			<table width="100%" border="0px">
				<tr>
					...
					<td style="font-weight:bold; vertical-align: middle" align="left">
						<label class="columna">Operaci�n Gravada</label>
					</td>
				</tr>
				<tr>
					<td align="right" >
					...
					<td style="font-weight:bold; vertical-align: middle" align="left">
						<label class="columna">Operaci�n Inafecta</label>
					</td>
				</tr>
				<tr>
					<td align="right" >
					...
					<td style="font-weight:bold; vertical-align: middle" align="left">
						<label class="columna">Operaci�n Exonerada</label>
					</td>
				</tr>
			</table>
			</div>
