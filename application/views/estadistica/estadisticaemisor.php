...
<head>
		...
		<script type="text/javascript">	
			...
			$(document).ready(function()
			{
				...
				$('#txt_FechaEmisionInicio').datepicker('setDate', 'today -6');
			...
			ncsistema=
			{
				...
				{	
					...
					newHtml+='<thead>';
					newHtml+='<tr>';						
						newHtml+='<td style="width:15%;">Tipo</td>';
						newHtml+='<td style="width:5%; background:#ADD8E6">Firmado</td>';
						newHtml+='<td style="width:10%; background:#ADD8E6">Aceptados</td>';
						newHtml+='<td style="width:10%; background:#ADD8E6">Rechazados</td>';
						newHtml+='<td style="width:10%; background:#ADD8E6">Pend. de Declaración</td>';
						newHtml+='<td style="width:10%; background:#ADD8E6">En Espera de Respuesta</td>';
						newHtml+='<td style="width:10%; background:#ADD8E6">Anulados</td>';
						
						newHtml+='<td style="width:5%; background:#DDA0DD">Borrador</td>';
						newHtml+='<td style="width:10%; background:#DDA0DD">Por Procesar</td>';
						newHtml+='<td style="width:10%; background:#DDA0DD">Procesado</td>';
						newHtml+='<td style="width:5%; background:#DDA0DD">Error</td>';
					...
					if (data.length>0)
					{
						...
						{	
							...
							newHtml+='<tr>';															
								...
								newHtml+='<td style="text-align:center; background:#ADD8E6">'+rs.firmado+'</td>';			
								newHtml+='<td style="text-align:center; background:#ADD8E6">'+rs.aceptado+'</td>';
								newHtml+='<td style="text-align:center; background:#ADD8E6">'+rs.rechazado+'</td>';
								newHtml+='<td style="text-align:center; background:#ADD8E6">'+rs.pendiente_declaracion+'</td>';
								newHtml+='<td style="text-align:center; background:#ADD8E6">'+rs.espera_respuesta+'</td>';
								newHtml+='<td style="text-align:center; background:#ADD8E6">'+rs.anulado+'</td>';
								
								newHtml+='<td style="text-align:center; background:#DDA0DD">'+rs.borrador+'</td>';
								newHtml+='<td style="text-align:center; background:#DDA0DD">'+rs.por_procesar+'</td>';
								newHtml+='<td style="text-align:center; background:#DDA0DD">'+rs.procesado+'</td>';
								newHtml+='<td style="text-align:center; background:#DDA0DD">'+rs.error+'</td>';	
								
							newHtml+='</tr>';	
							
							total1=total1+parseInt(rs.firmado);
							total2=total2+parseInt(rs.aceptado);
							total3=total3+parseInt(rs.rechazado);
							total4=total4+parseInt(rs.pendiente_declaracion);
							total5=total5+parseInt(rs.espera_respuesta);
							total6=total6+parseInt(rs.anulado);							
							total7=total7+parseInt(rs.borrador);
							total8=total8+parseInt(rs.por_procesar);
							total9=total9+parseInt(rs.procesado);
							total10=total10+parseInt(rs.error);
							
						});	
						newHtml+='<tr>';															
							newHtml+='<td style="text-align:center; background:#ADD8E6">TOTAL</td>';		
							newHtml+='<td style="text-align:center; background:#ADD8E6">'+total1+'</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">'+total2+'</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">'+total3+'</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">'+total4+'</td>';			
							newHtml+='<td style="text-align:center; background:#ADD8E6">'+total5+'</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">'+total6+'</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">'+total7+'</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">'+total8+'</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">'+total9+'</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">'+total10+'</td>';
						newHtml+='</tr>';
					...
					else
					{
						newHtml+='<tr>';															
							...
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';			
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">0</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">0</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">0</td>';
							newHtml+='<td style="text-align:center; background:#DDA0DD">0</td>';
						newHtml+='</tr>';
						...
						newHtml+='</tr>';
						newHtml+='<tr>';															
							newHtml+='<td style="text-align:left">RESUMEN DE BAJAS</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
						...
						newHtml+='</tr>';
						newHtml+='<tr>';															
							newHtml+='<td style="text-align:left">RESUMEN DE BOLETAS</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
						...
						newHtml+='<tr>';															
							newHtml+='<td style="text-align:center">TOTAL</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';
							newHtml+='<td style="text-align:center; background:#ADD8E6">0</td>';	
    ...
    <body>
		...
		<div id="tabs" style="width:99.7%;float:left;text-align:center;margin-top:5px">
			<ul>
				<li><a href="#tabs-1">ESTADÍSTICA DE ENVIO</a></li>
			</ul>
			<div id="tabs-1" style="width:95%;float:left">			
				...
				<div id="div_Resumen" style="width:100%;border:solid 0px;float:left;text-align:center;margin-top:5px">
					<table cellpadding="0" cellspacing="5" class="display" >
						<tr>						
							<td style="background:#ADD8E6;width:80px"></td>
							<td style="width:120px;text-align:left">Estados SUNAT</td>
						</tr>
						<tr>						
							<td style="background:#DDA0DD"></td>
							<td style="text-align:left">Estados Documento</td>
						</tr>
					</table>
				</div>
			</div>
