...
<?php header('Content-Type: text/html; charset=ISO-8859-1');?>
														...
														<tr> 
															<td style="width:100%" colspan="2" align="left">
																<table>
																	<tr>
																		<td>
																			<button style="width:110px; height:32px" id="btn_Verdetalle" title="Consulta anónima." 
	...
	<div id="dialog-form-detalleretenciones" title="Detalle del Comprobante de Retención">
		 <form>
			<div> 
				<div>
					<table width="100%" border="1">
