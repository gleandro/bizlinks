<?php
	...
	$ruta_formato='FormatoListaComprobantes.xlsx';
	$ruta_formato='nc_formatos/comprobantes/'.$ruta_formato;
	...
	*/
	...
	//prepare download
	$filename=   'ListaComprobantes';//$lista_datosdocumento[0]['nom_tipdoc'].'_'.$lista_datosdocumento[0]['ser_doc'].'-'.$lista_datosdocumento[0]['num_doc']; 
