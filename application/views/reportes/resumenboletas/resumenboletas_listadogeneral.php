<?php
	...
	$ruta_formato='FormatoResumenBoletas.xlsx';
	...
	if(!empty($lista_datosdocumento))//SI NO ES NULO O VACIO
	{
		if ($param10=='')
		{
			...
			{	
				...
				$PHPExcel->getActiveSheet()->setCellValue('G'. $fila, trim($val['bl_fechaenviosunat']));
	...
	*/
	...
	//prepare download
	$filename=   'ListaResumenBoletas';//$lista_datosdocumento[0]['nom_tipdoc'].'_'.$lista_datosdocumento[0]['ser_doc'].'-'.$lista_datosdocumento[0]['num_doc']; 
