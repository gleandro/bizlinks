...
<head>
		...
		<script type="text/javascript">	
			...
			$(document).ready(function()
			{
				...
				$("#tabs").tabs();
				ncsistema.Listar_DocumentosdeBajaTabla('',0);	
			...
			ncsistema=
			{
				Listar_DocumentosdeBaja:function()
				{
					...
					$.ajax({
						url:'<?php echo base_url()?>resumenbaja/Listar_Specancelheader',
						type: 'post',
						dataType: 'json',
						data:
						{
						...
						success:function(result)
						{
							...
							if(result.status==1)
							{
								ncsistema.Listar_DocumentosdeBajaTabla(result.data);
							}
				...
				{	
					...
					{						
						newHtml+='<tr>';															
							...
							newHtml+='<td style="text-align:left">'+rs.bl_fecharespuestasunat+'</td>';
				...
				Detalle_Comprobante:function()
				{
					...
					{
						$.ajax({
							url:'<?php echo base_url()?>resumenbaja/Listar_DetalleDocumento',
							type: 'post',
							dataType: 'json',
							data:
							{
				...
				{	
					...
					{									
						...
						newHtml+='<tr>';															
							...
							newHtml+='<td style="text-align:left">'+rs.seriedocumentobaja+'-'+rs.numerodocumentobaja+'</td>';
							newHtml+='<td style="text-align:left">'+rs.fechaemisioncomprobante+'</td>';
							newHtml+='<td style="text-align:left">'+rs.motivobaja+'</td>';
						newHtml+='</tr>';						
					});	
			...
			function Descargar_ExcelGeneral()
			{
				...
				*/
				...
				if (Cmb_OpcionesExportarExcel==1)
				{
					...
					document.location.href=urlexportardatos+'resumenbaja/Exportar_ExcelGeneral?param1='+txt_RucEmpresa+'&param2='+txt_CodigoResumen+'&param3='+txt_FechaGenInicio+'&param4='+txt_FechaGenFinal+'&param5='+Cmb_EstadoDocumento+'&param6='+txt_FechaEmisionInicio+'&param7='+txt_FechaEmisionFinal+'&param8='+txt_datosseleccionados+'&param9='+Cmb_EstadoDocumentoSunat;
				}
				else
				{
			...
			{
				var txt_RucEmpresa=$.trim($('#txt_RucEmpresa').val());	
				document.location.href=urlexportardatos+'resumenbaja/Descargar_ExcelDetalle?param1='+txt_RucEmpresa+'&param2='+resumenid;				
			}
			...
			function Descargar_ExcelDetalleVistaPrevia()
			{
				...
				{
					document.location.href=urlexportardatos+'resumenbaja/Descargar_ExcelDetalle?param1='+txt_RucEmpresa+'&param2='+txt_codigoresumenvistaprevia;				
				}
				else
				{
			...
			function ReiniciarCorrelativo_DocumentoSeleccionado()
			{
				...
				if (txt_cantidadseleccionados>0)
				{
					if (txt_cantidadseleccionados==txt_cantidaddocum_estado)
					{
						...
						{
							$.ajax({
								url:'<?php echo base_url()?>resumenbaja/Reiniciar_Correlativos',
								type: 'post',
								dataType: 'json',
								data:
								{
								...
								success:function(result)
								{
									if(result.status==1)
									{
										ncsistema.Listar_DocumentosdeBaja();
			...
			function Descargar_DocumentoSeleccionado()
			{
				...
				if (txt_cantidadseleccionados>0)
				{
					...
					$.ajax({
							url:'<?php echo base_url()?>resumenbaja/Crear_ArchivosDocumentoSeleccionado',
							type: 'post',
							dataType: 'json',
							data:
							{
			...
			function Descargar_DocumentoSeleccionadoArchivos()
			{
				var txt_datosseleccionados=$.trim($('#txt_datosseleccionados').val());	
				var txt_rucemisor=$.trim($('#txt_RucEmpresa').val());
				document.location.href=urlexportardatos+'resumenbaja/Descargar_DocumentoSeleccionado?param1='+txt_datosseleccionados+'&param2='+txt_rucemisor;	
			}
    ...
    <body>
		...
		<div id="tabs" style="width:99.7%;float:left;text-align:center;margin-top:5px">
			<ul>
				<li><a href="#tabs-1">LISTA DE RESUMEN DE BAJAS</a></li>
			</ul>
			<div id="tabs-1" style="width:95%;float:left">	
				...
				<div id="div_datosempresa" style="width:100%;border:solid 1px;float:left;margin-top:10px; border: 1px solid #a6c9e2;border-radius:5px;">
					<table border="0" width="60%" style="border-collapse:separate; border-spacing:1px 1px;" cellpadding="3" class="tablaFormulario">
						...
						<tr>
							<td style="text-align:right;"><label class="columna">Código Resumen:</label></td>
							<td style="text-align:left">
								<input style="width:95%" id="txt_CodigoResumen" type="text" value="" maxlength="13" />
							</td>							
							<td style="text-align:right"><label class="columna">Fec. Generación:</label></td>
							<td vertical-align="bottom" style="text-align:left;" >
						...
						<tr>
							...
							<td style="text-align:left;width:10%" colspan="4">
								<table width="100%" border="0">
								  <tr>
									<td  width="10%">
										<a href="javascript:ncsistema.Listar_DocumentosdeBaja()" >
			...
			<div style="width:100%;border:solid 1px;float:left;margin-top:10px; border: 1px solid #a6c9e2;border-radius:5px;">	
				<table width="100%" border="0px" class="ui-widget-header">
					...
					<tr>
						...
						<td style="text-align:left;width:35%; vertical-align:middle">
							<select id="Cmb_OpcionesExportarExcel" style="height:22px" >
						...
						<td align="right" style="width:60%; vertical-align:middle">
							<!--<a href="javascript:ReiniciarCorrelativo_DocumentoSeleccionado()" >								
							</a>-->
							...
							<button style="width:120px; height:32px"  id="btn_DescargarPrincipal" title="Iniciar Sesión" 
								class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left"
				...
				<div id="div_ListadoEmpresa" style="width:100%;border:solid 0px;float:left;text-align:center;margin-top:0px">
				</div>
			</div>
			</div>
		</div>
		...
		<div id="dialog-form-detalledocumento" title="Detalle de Resumen de Baja">
		 	<form>
